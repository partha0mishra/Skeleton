...
/**
 * Filter function that takes a Tuple2<T,Boolean> and if the Boolean flag is false, returns true.
 */
 ...
 */
public class FilterFalse<T> implements FilterFunction<Tuple2<T, Boolean>> {
